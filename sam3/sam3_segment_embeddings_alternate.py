...
# SAM3 Tracker for automatic mask generation
...
print("   Generating masks using grid sampling...")
all_masks = []
all_boxes = []
all_scores = []

width, height = image.size
points_per_side = 32  # Adjust for more/fewer segments (32x32 = 1024 points)
